...
function CadastrarImóveis() {
  ...
  const sendFileToIPFS = async (e) => {
    ...
    if (fileImg && formValues.estado && cidade && bairroI && numeroI && logradouro && cep && status) {
    ...
    <div className="cadastrarImóveis">
      ...
      <div className="flex justify-center gap-24 mt-8">
        <div>
          <div className="flex items-center mb-3">
            ...
            <h1 className="ml-3 text-lg">Cidade <span className="text-red-500">*</span></h1>
          </div>
        ...
        <div>
          <div className="flex items-center mb-3">
            <img src={estado} alt="" />
            <h1 className="ml-3 text-lg">Estado <span className="text-red-500">*</span></h1>
          </div>
      ...
      <div className="flex justify-center gap-24 mt-8">
        ...
        <div>
          <div className="flex items-center mb-3">
            ...
            <h1 className="ml-3 text-lg">Bairro <span className="text-red-500">*</span></h1>
          </div>
          <input className="border-2 border-gray-400 rounded-lg w-64 text-center" type="text" name="" id="" onChange={(e) => { setBairro(e.target.value) }} />
        </div>

        <div>
          <div className="flex items-center mb-3">
            <img className="w-9" src={numero} alt="" />
            <h1 className="ml-3 text-lg">Numero <span className="text-red-500">*</span></h1>
          </div>
          <input className="border-2 border-gray-400 rounded-lg w-64 text-center" type="number" name="" id="" onChange={(e) => { setNumero(e.target.value) }} />
        </div>
      ...
      <div className="flex justify-center gap-24 mt-8">
        <div>
          ...
          <input className="border-2 border-gray-400 rounded-lg w-64 text-center" type="text" name="" id="" onChange={(e) => { setLogradouro(e.target.value) }} />
        </div>

        <div>
          <div className="flex items-center mb-3 justify-center">
            <h1 className="ml-3 text-lg">CEP <span className="text-red-500">*</span></h1>
          </div>
          <input className="border-2 border-gray-400 rounded-lg w-64 text-center" type="text" name="" id="" onChange={(e) => { setCep(e.target.value) }} />
        </div>
      </div>
      ...
      <div className="">
        <div className="flex justify-center mt-10">
          ...
          <p>Imagem do imóvel <span className="text-red-600">*</span></p>
        </div>

        <form className="flex flex-col content-center items-center justify-center" onSubmit={(event) => { sendFileToIPFS(event) }}>
          <div className="rounded-md  h-36 border-dashed border-2 flex flex-col items-center justify-center p-5 w-96">
            ...
            <input className="" type="file" onChange={(e) => setFileImg(e.target.files[0])} required />
          </div>

          <div className="mt-5 mb-5">
            <button className="bg-blueGov h-12 text-white rounded-md w-32" type='submit'>Registar Imovel</button>
          </div>
